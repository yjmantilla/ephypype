...
pos = params["inverse"]['pos']  # spacing for volume grid
...
inv_sol_workflow = create_pipeline_source_reconstruction(
    data_path, subjects_dir, pos=pos, inv_method=inv_method, parc=parc,
    noise_cov_fname=noise_cov_fname, is_volume=True)
